           ...
           <h3><img height="50" width="55" src="<c:url value="/static/logo.png"/>"/><a href="/">Contacts List</a></h3>
                ...
                <div class="container-fluid">
                    ...
                    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                        <ul id="groupList" class="nav navbar-nav">
                            ...
                            <li><button type="button" id="save-csv" class="btn btn-default navbar-btn">Save to CSV</button></li>
                            <li><button type="button" id="upload-csv" class="btn btn-default navbar-btn">Load from CSV</button></li>
            ...
            <nav aria-label="Page navigation">
                <ul class="pagination">
                    ...
                    <c:if test="${byPattern ne null}">
                        <c:forEach var="i" begin="1" end="${byPattern}">
                            <li><a href="/search?pattern=${pattern}&page=<c:out value="${i - 1}"/>"><c:out value="${i}"/></a></li>
                        </c:forEach>
                    </c:if>
                </ul>
            </nav>
